...
public class Class implements Serializable {
    ...
    @JoinColumn(name = "Registration_NumberRegistration", referencedColumnName = "NumberRegistration", nullable = false)
    @ManyToOne(optional = false)
    private Registration registrationNumberRegistration;
    @JoinColumn(name = "Teacher_CPF", referencedColumnName = "CPF", nullable = false)
    @ManyToOne(optional = false)
